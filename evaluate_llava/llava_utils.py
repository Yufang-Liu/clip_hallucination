...
# adapted from run_llava.py, only change the args to avoid loading models multiple times and return output
...
def generate_output(model_path, all_data, output_file):
    ...
    for data in tqdm(all_data):
        ...
        data["answer"] = eval_model(model_args, tokenizer, model, image_processor)
