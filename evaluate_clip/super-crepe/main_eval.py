...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_cache_dir', default='../../cache/clip/', type=str, help="Directory to where downloaded models are cached")
    parser.add_argument('--output', type=str, default='../../output/clip_results/', help="Directory to where results are saved")

    parser.add_argument('--coco_image_root', type=str, default='../../data/coco_val2017/val2017/')
